...
void loadData()
{
    ...
    for(int i=0; i<objects; i++)
    {
        ...
        if(s=="sphere")
        {
            ...
            if(sphere==NULL)
            {
                cout<<"Error in creating sphere"<<endl;
                exit(0);
            }
        ...
        else if(s=="triangle")
        {
            ...
            if(triangle==NULL)
            {
                cout<<"Error in creating triangle"<<endl;
                exit(0);
            }
        ...
        else if(s=="general")
        {
           // cout<<"baal"<<endl;
            ...
            if(general==NULL)
            {
                cout<<"Error in creating general"<<endl;
                exit(0);
            }
    ...
    for(int i=0; i<point_lights; i++)
    {
       // cout<<i<<endl;
        ...
        if(pl==NULL)
        {
            cout<<"Error in creating point light"<<endl;
            exit(0);
        }
    ...
    for(int i=0; i<spot_lights; i++)
    {
        ...
        if(sl==NULL)
        {
            cout<<"Error in creating spot light"<<endl;
            exit(0);
        }
