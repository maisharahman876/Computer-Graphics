...
void keyboardListener(unsigned char key, int x,int y)
{
    ...
    case '3':
        ...
        u[0]=u[0]*cos(3*3.14/180)-l[0]*sin(3*3.14/180);
        u[1]=u[1]*cos(3*3.14/180)-l[1]*sin(3*3.14/180);
        u[2]=u[2]*cos(3*3.14/180)-l[2]*sin(3*3.14/180);
        break;
    case '4':
        l[0]=l[0]*cos(-3*3.14/180)+u[0]*sin(-3*3.14/180);
        l[1]=l[1]*cos(-3*3.14/180)+u[1]*sin(-3*3.14/180);
    ...
    case '6':
        ...
        u[0]=u[0]*cos(3*3.14/180)+r[0]*sin(3*3.14/180);
        u[1]=u[1]*cos(3*3.14/180)+r[1]*sin(3*3.14/180);
        u[2]=u[2]*cos(3*3.14/180)+r[2]*sin(3*3.14/180);
        break;
    case '5':
        r[0]=r[0]*cos(-3*3.14/180)-u[0]*sin(-3*3.14/180);
        r[1]=r[1]*cos(-3*3.14/180)-u[1]*sin(-3*3.14/180);
